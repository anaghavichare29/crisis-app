  ...
  const crises = [
    {
      ...
      details: "Floods occur due to heavy rainfall, river overflow, or dam failure. Stay on higher ground and avoid water currents."
    },
    {
      title: "Earthquake",
      description: "Sudden shaking of the ground due to tectonic movements.",
      details: "Earthquakes can collapse buildings. Stay under sturdy furniture and avoid open areas."
    },
    {
      title: "Fire",
      description: "Uncontrolled burning causing destruction.",
      details: "Use fire extinguishers if safe. Evacuate immediately and call emergency services."
    },
    {
      title: "Cyclone",
